...
async def check_health() -> Dict[str, Any]:
    ...
    try:
        ...
        if _consumer_instance:
            ...
            health_status["details"]["consumer"] = {"error": "Consumer instance not set"}
        ...
        if _consumer_instance and _consumer_instance.connection:
            try:
                if not _consumer_instance.connection.is_closed:
                    ...
                    health_status["details"]["rabbitmq"] = {"status": "connection_closed"}
            except Exception as e:
                health_status["details"]["rabbitmq"] = {"status": "error", "error": str(e)}
        else:
