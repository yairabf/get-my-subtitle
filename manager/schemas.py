...
class QueueStatusResponse(BaseModel):
    ...
    download_queue_size: int = Field(..., description="Number of items in download queue")
    translation_queue_size: int = Field(..., description="Number of items in translation queue")
    active_workers: Dict[str, int] = Field(..., description="Number of active workers by type")
